  ...
  <div class="main">
    <div class="box">
      ...
      if (isset($_POST['submit'])) {
        ...
        $cpass = $_POST['cpass'];
        if ($npass == $cpass) {
          $sql = "select password from customer where password='$opass' and cust_id='".$_SESSION['user_id']."'";
          $r = mysqli_query($con, $sql);
          if (mysqli_num_rows($r) > 0) {
            $sql1 = "update customer set password='$npass' where cust_id='".$_SESSION['user_id']."'";
